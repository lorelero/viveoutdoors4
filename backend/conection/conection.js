...
const { HOST, DATABASE, USER_A, PASSWORD, PORT, PORT_SERVER } = process.env; //extrae las variables de entorno necesarias para la conexión a la base de datos del archivo .env
