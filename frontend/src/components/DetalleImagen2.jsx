...
const productos = [
  ...
  },
  {
    ...
    detalle:
      "Mochila de trekking de 45L, ideal para tus aventuras y exploraciones en terrenos desconocidos. Diseñada para recorridos donde tú trazas el camino, ofrece un equilibrio perfecto entre simplicidad y robustez. Su construcción reforzada garantiza una confiabilidad excepcional, permitiéndote aventurarte sin preocupaciones, sin importar la distancia o las condiciones.",
    precio: "$112.990",
  },
  {
    id: 7,
  ...
  },
  {
    ...
    detalle:
      "Mochila 50 L fácil de ajustar para mujeres que hacen senderismo por varios días por la montaña. Buena capacidad para llevar todo lo necesario.",
    precio: "$75.000",
  },
  {
    id: 13,
    ...
    detalle:
      "¿Buscas una mochila cómoda y versátil sin sacrificar el peso? La MT500 AIR fue diseñada para ti por nuestro equipo de apasionados.",
    precio: "$120.000",
  },
  {
    id: 14,
    ...
    detalle:
      "Nuestros diseñadores, viajeros mochileros, crearon esta mochila compacta auxiliar para llevar las pertenencias esenciales durante las salidas de un día.",
    precio: "$16.000",
  },
  {
    id: 15,
    ...
    detalle:
      "Nuestros diseñadores mochileros crearon esta mochila para partir de aventura con total comodidad durante varias semanas.",
    precio: "$110.000",
  },
];
